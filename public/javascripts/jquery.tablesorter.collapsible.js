		...
		return this.each(function (){
			var $td = $(settings.selector, this),
				...
				$a.bind("click", function (){ 
	  			...
	  			parent_tr.find('span:first').attr('class',[bIsCollapsed ? "vendor_title" : "title"]);
	  		    parent_tr[bIsCollapsed ? "removeClass" : "addClass"]('collapsed_parent');
	  			parent_tr.children('td')[bIsCollapsed ? "removeClass" : "addClass"]('top_border');
	  			parent_tr.children('td:first')[bIsCollapsed ? "removeClass" : "addClass"]('left_border');
	  			parent_tr.children('td:last')[bIsCollapsed ? "removeClass" : "addClass"]('right_border');
	  			parent_tr.next().children('td:first')[bIsCollapsed ? "removeClass" : "addClass"]('left_border');
	  			parent_tr.next().children('td:last')[bIsCollapsed ? "removeClass" : "addClass"]('right_border');
